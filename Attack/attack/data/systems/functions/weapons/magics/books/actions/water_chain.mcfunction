...
# mp
    ...
    # pros
        ...
        ## action
        #give effect
            execute if entity @a[distance=..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] run effect give @a[distance=0.01..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] slowness 15 2
            #normal
