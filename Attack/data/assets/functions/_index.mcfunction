...
# @within systems:weapons/magics/books/actions/*
    ...
    #declare damage_type assets:weapons/magics/books/flash
    #declare damage_type assets:weapons/magics/books/dark
    #declare damage_type assets:weapons/magics/books/inferno
    #declare damage_type assets:weapons/magics/books/lightning
    #declare damage_type assets:weapons/magics/books/meteor
    #declare damage_type assets:weapons/magics/books/poison_drink
...
# @within systems:weapons/swords/ability/**
    ...
    #declare damage_type assets:weapons/swords/freeze