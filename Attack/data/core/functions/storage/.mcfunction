...
# set Datas
    ## registry
        data merge storage attack:registry {Main: {Calculation: {Seconds: 20, Minutes: 60, Hours: 60}, Const: {1000: 1000, 100: 100, 500: 50, 2: 2}, Weapons: {Magics: {Mp: {Max: 100, Smooth: 10}}}}}
