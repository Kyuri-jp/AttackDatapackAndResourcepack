# set datas
    ## registry
        ...
        data merge storage storage:registry {Main:{Sys:{Version:0.0.1,DataPackVersion:0.0.0l,ResourcePackVersion:0.0.1}}}
    ...
    ## settings
        ...
        data merge storage storage:settings {Main:{Weapons:{Magics:{Rods:{Shot:{Scope:30},UsingMp:{Explosion:40,Dark:30,Drain:45,Lightning:60,Meteor:80,WaterChain:20,Flash:35,Reel:45}}}}}}
