...
# set
    ...
    item replace entity @a[tag=operator,tag=!game.players.playing] hotbar.1 with carrot_on_a_stick{display: {Name: '{"text": "Setting","color": "gray","italic": false}'}, ButtonTag: Setting, CustomModelData: 2}