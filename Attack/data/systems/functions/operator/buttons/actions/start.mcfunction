...
# notice
    ...
    execute if score $Count.Players.Red Datas matches ..0 run return run function api:system/util/error_notice/
    ...
    execute if score $Count.Players.Blue Datas matches ..0 run return run function api:system/util/error_notice/
