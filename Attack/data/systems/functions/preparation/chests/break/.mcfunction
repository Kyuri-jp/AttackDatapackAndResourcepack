# breakChests
    ## normal chest
        execute as @e[type=text_display,tag=game.anchor.break.chest] at @s run fill ~3 ~ ~3 ~-3 ~ ~-3 air replace chest

    ## fix chest
        execute at @e[type=armor_stand,tag=game.anchor.set.chest.tire3] run fill ~3 ~ ~3 ~-3 ~ ~-3 air replace chest
        execute at @e[type=armor_stand,tag=game.anchor.set.chest.tire5] run fill ~3 ~ ~3 ~-3 ~ ~-3 air replace chest
