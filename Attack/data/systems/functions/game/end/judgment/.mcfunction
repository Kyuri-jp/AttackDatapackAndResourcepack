...
# judgement
    ...
    ## draw
        ...
        execute if score RedTeamScore Scores = BlueTeamScore Scores if data storage storage:settings {Main:{Custom:{Switch:{Ex:1b}}}} run function systems:game/ex/set_values
