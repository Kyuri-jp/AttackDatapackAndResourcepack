...
# detect
    execute as @a at @s if entity @s[y=-38,dy=0,team=!watch,team=!preparation,tag=Player.Playing] if entity @e[type=armor_stand,tag=Anchor.ScopeOver,distance=..40] run scoreboard players set @s scopeOver 1

# return
    execute as @a at @s if entity @s[y=-38,dy=0,team=preparation,tag=Player.Playing] if entity @e[type=armor_stand,tag=Anchor.ScopeOver,distance=..40] run effect give @s jump_boost 1 255 true
    execute as @a at @s if entity @s[y=-38,dy=0,team=preparation,tag=Player.Playing] if entity @e[type=armor_stand,tag=Anchor.ScopeOver,distance=..40] run tp @s @e[type=armor_stand,tag=Anchor.DefaultSpawnPoint,limit=1]
