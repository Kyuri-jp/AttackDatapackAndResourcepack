...
# action
    ...
    execute if entity @a[distance=..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] at @a[distance=..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] if entity @a[tag=weapons.magics.rods.user,limit=1,team=blueTeam] run damage @a[distance=..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] 8 assets:weapons/magics/books/meteor by @a[tag=weapons.magics.rods.user,limit=1]
