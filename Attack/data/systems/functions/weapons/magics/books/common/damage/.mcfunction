...
# damage set
    ...
    execute store result storage attack:temporary Magics.Damage.UnJust float 1 run data get storage attack:temporary Magics.Damage.Base 1.2
    execute store result storage attack:temporary Magics.Damage.UnJust.Remove float 1 run data get storage attack:temporary Magics.Damage.Base 0.2
    execute store result score $Magic.Shot.Damage.UnJust Temporary run data get storage attack:temporary Magics.Damage.UnJust 10
    execute store result score $Magic.Shot.Damage.UnJust.Remove Temporary run data get storage attack:temporary Magics.Damage.UnJust.Remove 10
