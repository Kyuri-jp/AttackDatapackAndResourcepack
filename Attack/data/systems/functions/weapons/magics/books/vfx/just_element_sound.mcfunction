...
#fire
    execute if score $magics.rods.elements.just datas matches 3 run playsound entity.blaze.shoot player @s ~ ~ ~
#water
    execute if score $magics.rods.elements.just datas matches 4 run playsound entity.player.splash player @s ~ ~ ~ 5