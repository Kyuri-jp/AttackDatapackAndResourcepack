...
# damage
    execute as @a[tag=weapons.swords.damage.additional_damage.freeze] at @s run damage @s 0.1 assets:weapons/swords/freeze by @p[distance=0.01..,tag=weapons.swords.attacker.freeze]
