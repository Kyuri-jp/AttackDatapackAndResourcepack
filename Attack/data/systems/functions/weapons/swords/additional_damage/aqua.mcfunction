...
# damage and vfx
    execute as @a[tag=weapons.swords.damage.additional_damage.aqua] at @s run damage @s 0.2 assets:weapons/swords/aqua by @p[distance=0.01..,tag=weapons.swords.attacker.aqua]
