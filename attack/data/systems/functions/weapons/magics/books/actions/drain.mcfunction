...
# mp
    ...
    # pros
        ...
        ## hit player
            execute if entity @a[distance=..2,limit=1,sort=nearest,tag=!weapons.magics.rods.user] run playsound entity.generic.drink player @a[distance=..2,limit=1]
            execute if entity @a[distance=..2,limit=1,sort=nearest,tag=!weapons.magics.rods.user] at @a[distance=..2,limit=1] run particle heart ~ ~ ~ 1 1 1 1 10 normal
