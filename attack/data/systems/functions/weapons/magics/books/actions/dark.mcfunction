...
# mp
    ...
    # pros
        ...
        ## action
        #darkness
            execute if entity @a[distance=..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] run effect give @a[distance=0.01..1.5,limit=1,sort=nearest,tag=!weapons.magics.rods.user] darkness 5 0
            #normal
