...
# set
execute if predicate libs:datas_set as @e[type=armor_stand,tag=game.anchor.set.chest.placer.1] at @s run setblock ^20 ^ ^ chest{LootTable:"loots:chests/items/tire_1"} keep
execute if predicate libs:datas_set as @e[type=armor_stand,tag=game.anchor.set.chest.placer.2] at @s run setblock ^29 ^ ^ chest{LootTable:"loots:chests/items/tire_2"} keep
execute if predicate libs:datas_set as @e[type=armor_stand,tag=game.anchor.set.chest.placer.3] at @s run setblock ^19 ^ ^ chest{LootTable:"loots:chests/items/tire_4"} keep
